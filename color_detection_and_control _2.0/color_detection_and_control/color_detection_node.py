...
class ColorDetectionNode:
    def __init__(self):
        ...
        self.lower_black = np.array([0, 15, 0])
        self.upper_black = np.array([179, 150, 210])
        ...
        self.min_area = 17000  # Valor inicial da área mínima, pode ser ajustado dinamicamente
    ...
    def image_callback(self, data):
        ...
        if detected_green and detected_blue and detected_orange:
            ...
            for contour in all_contours:
                ...
                distance_to_center = np.sqrt((rect_center_x - center_x) ** 2 + (rect_center_y - center_y) ** 2)
            ...
            cv_image = self.add_text(cv_image, f'Area RET: {area:.2f} px', (10, 120))
    ...
    def calculate_distance_cm(self, point1, point2):
        ...
        distance_cm = distance_meters * 100  # Use 100 instead of 620 for a more accurate distance calculation
        return distance_cm
